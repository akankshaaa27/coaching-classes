                ...
                {isModalOpen && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 overflow-y-auto">
                        ...
                        <motion.div
                            ...
                            className="relative bg-white rounded-[50px] p-10 max-w-4xl w-full shadow-2xl my-8 max-h-[90vh] overflow-y-auto scrollbar-thin"
                        >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-10">
                                ...
                                <div className="space-y-8">
                                    ...
                                    {formData.modules.map((mod, mIdx) => (
                                        <div key={mIdx} className="p-8 rounded-[35px] bg-slate-50 border border-slate-100 space-y-6 relative group">
                                            <button
                                                type="button"
                                ...
                                <div className="flex gap-4 pt-4 sticky bottom-0 bg-white pb-2 border-t border-slate-50 pt-6">
                                    <button
